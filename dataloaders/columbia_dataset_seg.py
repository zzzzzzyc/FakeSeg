...
class ColumbiaValDataset(Dataset):
    ...
    def __init__(
        ...
        self.osn_dir = (
            os.path.join(base_dir, osn_root, f"Columbia_{osn_platform}")
            if osn_platform
            else None
        )
    ...
    def _collect_samples(self):
        ...
        if os.path.isdir(splc_dir):
            ...
            for name in os.listdir(splc_dir):
                ...
                original_img_path = os.path.join(splc_dir, name)
                ...
                image_path = self._resolve_osn_image(original_img_path)
        ...
        if not self.tampered_only and os.path.isdir(auth_dir):
            for name in os.listdir(auth_dir):
                ...
                original_img_path = os.path.join(auth_dir, name)
