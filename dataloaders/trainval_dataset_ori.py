...
def collate_fn_train(batch, tokenizer=None, conv_type="llava_v1", use_mm_start_end=True):
    ...
    offset_list = [0]
    cnt = 0
    for (image_path, images, images_clip, conversations, masks, sam_mask_shape, exists) in batch:
