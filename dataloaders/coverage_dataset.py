...
class COVERAGEValDataset(Dataset):
    ...
    We use:
      pristine image: image/*.tif except *t.tif
      tampered image: image/*t.tif
    ...
    def __init__(
        ...
        self.real_answer_list = [
            "This is a real image, no segmentation needed: [REJ].",
            "The image is authentic, no segmentation required: [REJ].",
            "It is real: [REJ].",
            "No manipulation is present in this image: [REJ].",
            "This image appears authentic and untampered: [REJ]."
        ]
        ...
        print(
            f"[COVERAGE] total samples: {len(self.samples)} | "
            ...
            if self.tampered_only:
                ...
                out.append(
                    dict(
                        ...
                        mask_path=mask_path,
                        id=base_id,
                        is_tampered=low_stem.endswith("t"),
                    )
                )
    ...
    def __getitem__(self, idx: int):
        ...
        exists = [is_tampered and masks.shape[0] > 0]
